...
| riscv64 | Partial | Dev time is more focused on x86-64. Incomplete Port. Hardware not owned yet |
...
| riscv64 | - RV64GC CPU<br>- 512 MB RAM<br>- Working UEFI/ACPI<br>- OpenSBI 0.2+<br>- Monitor **or** serial port |
| loongarch64 | - TBD |
